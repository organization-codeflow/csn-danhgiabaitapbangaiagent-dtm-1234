# csn-danhgiabaitapbangaiagent-dtm-1234
...
```bash
git clone https://github.com/organization-codeflow/csn-danhgiabaitapbangaiagent-dtm-1234.git
cd csn-danhgiabaitapbangaiagent-dtm-1234
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=csn-danhgiabaitapbangaiagent-dtm-1234
- Xem các metrics:
